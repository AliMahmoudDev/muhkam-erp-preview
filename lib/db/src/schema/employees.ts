...
export const employeesTable = pgTable("employees", {
  ...
  national_id_image:  text("national_id_image"),
  ...
  salary_type:               text("salary_type").notNull().default("fixed"),
  commission_rate:           numeric("commission_rate", { precision: 5, scale: 2 }),
  commission_basis:          text("commission_basis"),
  commission_scope_dept_id:  integer("commission_scope_dept_id").references(() => departmentsTable.id),
