...
export function AnnouncementBanner() {
  ...
  function prev() { setIdx(i => (i - 1 + visible.length) % visible.length); }
  function next() { setIdx(i => (i + 1) % visible.length); }
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "4px", flexShrink: 0 }}>
          <button
            ...
            style={{
              ...
              color: style.text, opacity: 0.7, padding: "2px",
      ...
      <button
        ...
        style={{
          background: "none", border: "none", cursor: "pointer",
          color: style.text, opacity: 0.6, padding: "2px",
