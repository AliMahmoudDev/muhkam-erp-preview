...
describe('GET /api/employees', () => {
  ...
  it('يجب أن يرجع 200 ومصفوفة الموظفين', async () => {
    ...
    const res = await request(app).get('/api/employees').set('Authorization', 'Bearer test-token');
  ...
  it('يجب أن يعزل بيانات الشركة — company B لا ترى موظفي company A', async () => {
    ...
    const resA = await request(app).get('/api/employees').set('Authorization', 'Bearer test-token');
    ...
    const resB = await request(app).get('/api/employees').set('Authorization', 'Bearer test-token');
...
describe('GET /api/job-titles', () => {
  ...
  it('يجب أن يرجع 200 ومصفوفة المسميات الوظيفية', async () => {
    ...
    const res = await request(app).get('/api/job-titles').set('Authorization', 'Bearer test-token');
