...
interface PauseState   { until: number; reason: string; manual: boolean }
interface WarningState { firedAt: number }
...
class AnomalyDetector {
  ...
  async prune(): Promise<void> { /* noop — Redis TTLs handle expiry */ }
