      ...
      {activeTab === 'report' && (
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <input type="date" value={reportFrom} onChange={(e) => setReportFrom(e.target.value)} className="glass-input rounded-xl px-3 py-1.5 text-sm text-white" />
            <span className="text-white/40 text-xs font-bold">إلى</span>
            <input type="date" value={reportTo} onChange={(e) => setReportTo(e.target.value)} className="glass-input rounded-xl px-3 py-1.5 text-sm text-white" />
          </div>
                      ...
                      return (
                        <tr key={`${row.date ?? ''}-${row.type}-${row.reference_no ?? ''}-${i}`} className="border-b border-white/5 erp-table-row">
                          ...
                          <td className="p-3 text-white/70">
                            {row.description}
                            {row.reference_no && <span className="text-white/30 text-xs mr-2">{row.reference_no}</span>}
                          </td>
