    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
      ...
      {totalSupplierPayments > 0 && (
        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-2xl p-3 text-center">
          ...
          <p className="text-white font-black">{formatCurrency(totalSupplierPayments)}</p>
          <p className="text-white/40 text-xs">{supplierPayments.length} حركة</p>
        </div>
      )}
      {totalPurchaseReturns > 0 && (
        <div className="bg-violet-500/10 border border-violet-500/20 rounded-2xl p-3 text-center">
          ...
          <p className="text-white font-black">{formatCurrency(totalPurchaseReturns)}</p>
          <p className="text-white/40 text-xs">{purchaseReturns.length} مرتجع</p>
        </div>
      )}
      {totalReturns > 0 && (
