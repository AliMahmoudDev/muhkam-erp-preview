...
import { CARD_ICON_REGISTRY, STATUS_MAP, relativeTimeAr } from './repairConstants';
...
export default function DashboardCardsSection({
  ...
  const cards: DashboardCard[] = Array.isArray(dashboard.cards) ? dashboard.cards : [];
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2 flex-wrap">
        {cards.map((card) => {
          ...
          const isActive = activeStatusFilter === statuses.join(',');
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <span
                  className="text-[9px] font-bold uppercase tracking-widest truncate flex-1"
      ...
      {expandedId != null &&
        (() => {
          ...
          if (!card) return null;
          const Icon = CARD_ICON_REGISTRY[card.icon] ?? Wrench;
          const breakdown: DashboardCard['breakdown'] = Array.isArray(card.breakdown)
            ? card.breakdown
            : [];
          return (
            <div
            ...
            >
              ...
              {card.last_update && (
                <div className="flex items-center gap-2 text-[11px] text-ink/55 pt-2 border-t border-line">
                  ...
                  <span className="mr-auto text-ink/35">
