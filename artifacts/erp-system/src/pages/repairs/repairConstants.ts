...
export const STATUS_MAP: Record<string, { label: string; color: string; bg: string; icon: React.FC<{ className?: string }> }> = {
  ...
  delivered:                  { label: 'تم التسليم',            color: 'text-rose-400',     bg: 'bg-rose-500/15 border-rose-500/30',      icon: Truck },
  cancelled:                  { label: 'ملغي',                  color: 'text-red-400',      bg: 'bg-red-500/15 border-red-500/30',        icon: Ban },
  received:                   { label: 'استلام الجهاز',          color: 'text-orange-400',   bg: 'bg-orange-500/15 border-orange-500/30',  icon: Package },
  initial_inspection:         { label: 'الفحص الأولي',           color: 'text-blue-400',     bg: 'bg-blue-500/15 border-blue-500/30',      icon: Search },
  ...
  final_quality_check:        { label: 'مراقبة الجودة',          color: 'text-rose-400',     bg: 'bg-rose-500/15 border-rose-500/30',      icon: Star },
...
export const STATUS_BORDER: Record<string, string> = {
  received: 'border-orange-500/30', initial_inspection: 'border-blue-500/30',
  diagnosis: 'border-blue-500/30', waiting_customer_approval: 'border-amber-500/30',
  approved: 'border-emerald-500/30', in_repair: 'border-teal-500/30',
  repaired: 'border-teal-500/30', final_quality_check: 'border-rose-500/30',
...
export const STATUS_BAR_COLOR: Record<string, string> = {
  ...
  delivered:                 'bg-rose-500/60',
  cancelled:                 'bg-red-500/60',
  received:                  'bg-orange-400/60',
  initial_inspection:        'bg-blue-400/60',
  diagnosis:                 'bg-blue-400/60',
  waiting_customer_approval: 'bg-amber-400/60',
  approved:                  'bg-emerald-400/60',
  in_repair:                 'bg-teal-500/60',
  repaired:                  'bg-teal-500/60',
  final_quality_check:       'bg-rose-500/60',
