    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 flex-wrap items-center">
        ...
        >
          ...
          <span className="px-1.5 py-0.5 rounded-md bg-surface text-[10px] font-mono">{zeroCount}</span>
        </button>
        <button
          onClick={() => {
        ...
        >
          ...
          <span className="px-1.5 py-0.5 rounded-md bg-surface text-[10px] font-mono">{positiveCount}</span>
        </button>
        <button
          onClick={() => {
            setShowLowOnly((p) => !p);
        ...
        >
          ...
          <span className="px-1.5 py-0.5 rounded-md bg-surface text-[10px] font-mono">{lowCount}</span>
        </button>
      </div>
