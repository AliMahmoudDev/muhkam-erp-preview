...
interface WarehouseSectionProps {
  ...
  setWhForm: (fn: (f: { name: string; address: string; branch_id: string }) => { name: string; address: string; branch_id: string }) => void;
}
            ...
            {warehouses.map((w) => {
              ...
              return (
                ...
                >
                  ...
                  {w.address && (
                    <p className="text-ink/40 text-xs truncate">{w.address}</p>
                  )}
                  {/* الفرع */}
        ...
        >
          ...
          >
            ...
            {whDetailLoading ? (
              ...
              <>
                <p className="text-ink/40 text-xs mb-3">{whDetailProducts.length} صنف في هذا المخزن</p>
                  ...
                  <table className="w-full text-sm">
                        ...
                        return (
                          <tr key={p.id} className="border-b border-line erp-table-row">
                            ...
                            <td className="p-3 text-center">
                              {p.category ? (
                                <span className="px-2 py-0.5 rounded-lg bg-surface text-ink/50 text-xs">{p.category}</span>
                            ...
                            <td className="p-3 text-center font-bold text-ink">{formatCurrency(p.total_value)}</td>
                          </tr>
                        );
                      })}
                    </tbody>
                    <tfoot>
                      <tr className="border-t border-line bg-surface">
                        <td colSpan={4} className="p-3 text-ink/50 font-bold">الإجمالي</td>
