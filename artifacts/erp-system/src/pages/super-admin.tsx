                          ...
                          <div style={{ maxHeight: '480px', overflowY: 'auto' }}>
                            {auditData!.rows.map(row => {
                              ...
                              const REC_AR: Record<string, string> = {
                                ...
                                purchase_return: 'مرتجع مشتريات', product: 'منتج / صنف',
                                financial_lock: 'قفل مالي', expense: 'مصروف', income: 'إيراد',
                                safe_transfer: 'تحويل خزينة', receipt_voucher: 'سند قبض',
                                payment_voucher: 'سند صرف', deposit_voucher: 'سند إيداع',
                                treasury_voucher: 'سند خزينة', journal_entry: 'قيد يومية',
                                user: 'مستخدم', erp_user: 'حساب مستخدم',
                                account_balances: 'أرصدة الحسابات', customer_balances: 'أرصدة العملاء',
                                ...
                                repair_job: 'بطاقة صيانة', trial_monitoring: 'مراقبة الفترة التجريبية',
                                branch: 'فرع', device: 'جهاز', warehouse: 'مستودع',
                                stock_transfer: 'تحويل مخزون', inventory_count: 'جرد مخزون',
                              };
