...
function AdvanceRequestModal({ empId, currency, isDark, border, onClose }: {
  ...
  return (
    <div style={{ position:'fixed', inset:0, zIndex:100, display:'flex', alignItems:'center', justifyContent:'center', background:'rgba(0,0,0,0.55)', backdropFilter:'blur(4px)' }}>
      <div dir="rtl" style={{ width:'100%', maxWidth:420, borderRadius:20, background:bg, border:`1px solid ${border}`, padding:28, position:'relative', boxShadow:'0 20px 60px rgba(0,0,0,0.35)' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:20 }}>
          <span style={{ width:40, height:40, borderRadius:11, background:'rgba(245,158,11,0.18)', display:'flex', alignItems:'center', justifyContent:'center', color:'#f59e0b' }}>
            <Wallet size={20} />
          </span>
          <div>
            <p style={{ fontSize:16, fontWeight:900, color:textMain }}>طلب سلفة مالية</p>
            <p style={{ fontSize:12, color:isDark?'rgba(255,255,255,0.45)':'rgba(0,0,0,0.45)' }}>سيُرسَل للمدير للموافقة</p>
          </div>
        </div>

        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          <div>
            <label style={{ fontSize:12, fontWeight:700, color:textMain, display:'block', marginBottom:6 }}>
              المبلغ المطلوب ({currency})
            </label>
            <input
              type="number" min="1" value={amount} onChange={e => setAmount(e.target.value)}
              placeholder="أدخل المبلغ..."
              style={{ width:'100%', padding:'10px 14px', borderRadius:10, border:`1px solid ${border}`, background:inputBg, color:textMain, fontSize:14, fontFamily:'inherit', outline:'none', boxSizing:'border-box' }}
            />
          </div>
          <div>
            <label style={{ fontSize:12, fontWeight:700, color:textMain, display:'block', marginBottom:6 }}>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="اذكر سبب طلبك..."
              rows={3}
              style={{ width:'100%', padding:'10px 14px', borderRadius:10, border:`1px solid ${border}`, background:inputBg, color:textMain, fontSize:13, fontFamily:'inherit', outline:'none', resize:'vertical', boxSizing:'border-box' }}
            />
          </div>
        </div>
        ...
        <div style={{ display:'flex', gap:10, marginTop:20 }}>
          <button
            ...
            style={{ flex:1, padding:'11px 0', borderRadius:11, border:'none', cursor:'pointer',
              ...
              opacity: (!amount || parseFloat(amount) <= 0 || isPending) ? 0.6 : 1 }}
          >
