...
export function CreateCompanyForm({
  newName, setNewName,
  newPlan, setNewPlan,
  newEdition, setNewEdition,
  newDays, setNewDays,
  newAdminName, setNewAdminName,
  newAdminUsername, setNewAdminUsername,
  setShowCreate, setCreateResult,
  coMutate,
}: {
  newName: string; setNewName: (v: string) => void;
  newPlan: string; setNewPlan: (v: string) => void;
  newEdition: 'advanced' | 'ultimate'; setNewEdition: (v: 'advanced' | 'ultimate') => void;
  newDays: number; setNewDays: (v: number) => void;
  newAdminName: string; setNewAdminName: (v: string) => void;
  newAdminUsername: string; setNewAdminUsername: (v: string) => void;
