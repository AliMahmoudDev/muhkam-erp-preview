...
export function TabHealth({ healthData, healthLoading, onRefetch, healthUpdated, redisHealth }: Props) {
  return (
      ...
      {healthLoading ? (
        ...
        <>
          ...
          {(() => {
            ...
            return (
              <div style={{
                background: bgColor, borderRadius: '16px', border: `1px solid ${color}33`,
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                  ...
                  <div style={{ width: 14, height: 14, borderRadius: '50%', background: color, boxShadow: `0 0 8px ${color}`, flexShrink: 0 }} />
                </div>
              </div>
            );
          })()}
