    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
      {[
        ...
        },
        {
          ...
          color: (stats?.expired ?? 0) > 0 ? 'var(--status-danger)' : 'var(--status-success)',
          action: () => {
            setActiveTab('companies');
        ...
        <div
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLDivElement).style.boxShadow = `0 8px 24px ${kpi.color}20`;
          }}
          onMouseLeave={(e) => {
        ...
        >
          ...
          <div style={{ fontSize: '32px', fontWeight: 900, color: kpi.color, lineHeight: 1 }}>
            {kpi.value}
          </div>
