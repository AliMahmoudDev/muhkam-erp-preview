    ...
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
      ...
      <div
        style={{
          ...
          background: tgBotStatus?.connected
            ? 'rgba(52,211,153,0.07)'
            : tgBotStatus && !tgBotStatus.connected
              ? 'rgba(239,68,68,0.06)'
              : TG_BG,
          padding: '16px 20px',
          display: 'flex',
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: C.muted }}>
              أنشئ بوتاً عبر @BotFather في تيليجرام واحفظ بياناته هنا
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                placeholder={
                  tgBotStatus?.token_masked ?? '123456789:ABCDEF-ghijklmnopqrstuvwxyz...'
                }
                value={tgBotToken}
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button
              ...
              style={{
                ...
                border: 'none',
                background:
                  tgCredSaving || !tgBotToken.trim() || !tgChatId.trim()
            ...
            <button
              ...
              style={{
                ...
                color: tgBotStatus?.connected ? 'var(--status-success)' : C.muted,
                fontSize: '13px',
                fontWeight: 800,
                fontFamily: FONT,
          ...
          {tgTestResult && (
            <div
              style={{
                ...
                fontSize: '12px',
                fontWeight: 700,
                color: tgTestResult.ok ? 'var(--status-success)' : 'var(--status-danger)',
              }}
            >
      ...
      {tgError && !tgConfig && (
        ...
        >
          <div style={{ fontSize: '13px', color: 'var(--status-danger)' }}>
            ❌ تعذّر تحميل إعدادات التنبيهات
          </div>
          <button
            onClick={() => void tgRefetch()}
            style={{
              padding: '8px 18px',
              borderRadius: '10px',
      ...
      {tgConfig && (
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '11px', color: C.muted }}>
                  تحكم في أنواع التنبيهات وفترة الانتظار بين كل تنبيه
                </div>
              </div>
            </div>
            <TgToggle
          ...
          <div
            style={{ padding: '12px 18px', display: 'flex', flexDirection: 'column', gap: '4px' }}
          >
            {Object.entries(tgConfig.alerts).map(([key, rule]) => (
              <div
                ...
                style={{
                  ...
                  padding: '10px 12px',
                  borderRadius: '10px',
                  background: rule.enabled ? `${TG_BLUE}08` : 'transparent',
                  border: `1px solid ${rule.enabled ? `${TG_BLUE}25` : 'transparent'}`,
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div
                      style={{
                        fontSize: '13px',
                        fontWeight: 700,
                        color: rule.enabled ? C.text : C.muted,
                        whiteSpace: 'nowrap',
                        overflow: 'hidden',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <input
                        ...
                        setTgConfig((c) => {
                          ...
                          return {
                            ...
                            alerts: {
                              ...
                              [key]: {
                                ...rule,
                                cooldownHours: Math.max(0, Math.min(168, Number(e.target.value))),
                              },
                            },
                          };
                        })
                      ...
                      style={{
                        ...
                        padding: '4px 8px',
                        borderRadius: '8px',
                        border: `1px solid ${rule.enabled ? `${TG_BLUE}40` : C.border}`,
                        background: rule.enabled ? 'rgba(15,23,42,0.6)' : 'rgba(15,23,42,0.2)',
                        color: rule.enabled ? C.text : C.muted,
                        fontSize: '13px',
                        outline: 'none',
                        textAlign: 'center',
                  ...
                  <TgToggle
                    ...
                    onClick={() =>
                      setTgConfig((c) => {
                        ...
                        return {
                          ...c,
                          alerts: { ...c.alerts, [key]: { ...rule, enabled: !rule.enabled } },
                        };
                      })
                    }
          ...
          <div style={{ padding: '14px 18px', borderTop: `1px solid ${C.border}` }}>
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: 'none',
                background: tgSaving ? C.border : TG_BLUE,
                color: tgSaving ? C.muted : 'var(--bg-app)',
                fontSize: '13px',
                fontWeight: 800,
