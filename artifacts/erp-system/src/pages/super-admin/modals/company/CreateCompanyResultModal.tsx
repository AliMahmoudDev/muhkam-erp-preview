    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <div
            style={{ fontSize: '13px', color: 'var(--text-2)', marginTop: '4px', fontFamily: FONT }}
          >
        ...
        >
          ...
          {[
            ...
            { label: 'اسم المستخدم', value: createResult.username, mono: true, secret: false },
            {
              ...
              value: createResult.temp_password,
              mono: true,
              secret: true,
            },
          ].map((row) => (
            ...
            >
              <span style={{ fontSize: '12px', color: 'var(--status-warning)', fontFamily: FONT }}>
                {row.label}
              </span>
                ...
                {row.mono ? (
                  <code
                    style={{
                      ...
                      fontWeight: 800,
                      color: row.secret ? '#ea580c' : 'var(--bg-elevated)',
                      background: row.secret ? '#fff7ed' : 'var(--text-1)',
                      padding: '4px 10px',
                      borderRadius: '8px',
