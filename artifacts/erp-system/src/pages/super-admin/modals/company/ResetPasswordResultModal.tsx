    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <div
            style={{ fontSize: '13px', color: 'var(--text-2)', marginTop: '6px', fontFamily: FONT }}
          >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '13px', color: 'var(--text-2)', fontFamily: FONT }}>
                اسم المستخدم:
              </span>
              <span
                style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <button
                  onClick={() => {
                    void navigator.clipboard.writeText(resetPassResult.temp_password);
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: '1.5px solid #7c3aed44',
                    background: resetPassCopied ? 'var(--status-info)' : '#f9f5ff',
                    color: resetPassCopied ? 'var(--text-1)' : 'var(--status-info)',
                    fontSize: '12px',
                    cursor: 'pointer',
                    transition: 'all 0.2s',
                    fontFamily: FONT,
