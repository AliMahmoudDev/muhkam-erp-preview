...
export function SnapshotModal({ snapshotCompany, setSnapshotCompany, snapshotData, snapshotLoading }: Props) {
  ...
  return (
    <div
      ...
      style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', backdropFilter: 'blur(6px)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}
    >
      <div style={{ background: C.card, borderRadius: '24px', border: `1.5px solid ${C.border}`, width: '100%', maxWidth: '720px', maxHeight: '90vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        {/* Header */}
