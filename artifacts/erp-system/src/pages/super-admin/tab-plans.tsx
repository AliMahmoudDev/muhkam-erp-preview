...
export function TabPlans({ planSettings, planSettingsLoading, editingPlan, setEditingPlan, planSaving, onSavePlan }: Props) {
  return (
    <div>
                ...
                {isEditing ? (
                  <>
                    <div>
                      ...
                      <input
                        ...
                        style={{ width: '100%', background: C.surface, border: `1px solid ${C.border}`, borderRadius: '8px', padding: '8px 12px', color: C.text, fontSize: '14px', fontFamily: FONT, boxSizing: 'border-box' }}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        style={{ width: '100%', background: C.surface, border: `1px solid ${C.border}`, borderRadius: '8px', padding: '8px 12px', color: C.text, fontSize: '13px', fontFamily: FONT, boxSizing: 'border-box' }}
                      />
                    </div>
                    <div>
                      <label style={{ fontSize: '11px', color: C.muted, display: 'block', marginBottom: '4px' }}>السعر الشهري (ج.م.)</label>
                      <input
                        type="number" min={0} value={ep.price}
                        onChange={e => setEditingPlan({ ...ep, price: Number(e.target.value) })}
                        style={{ width: '100%', background: C.surface, border: `1px solid ${C.border}`, borderRadius: '8px', padding: '8px 12px', color: C.orange, fontSize: '18px', fontWeight: 800, fontFamily: FONT, boxSizing: 'border-box' }}
                      />
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
                      ...
                      <button
                        ...
                        style={{ flex: 1, background: 'transparent', color: C.muted, border: `1px solid ${C.border}`, borderRadius: '10px', padding: '10px', fontWeight: 700, fontSize: '13px', fontFamily: FONT, cursor: 'pointer' }}
                      >إلغاء</button>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <button
                      ...
                      style={{ background: 'transparent', border: `1.5px solid ${C.orange}`, color: C.orange, borderRadius: '10px', padding: '8px', fontWeight: 700, fontSize: '13px', fontFamily: FONT, cursor: 'pointer', marginTop: '4px' }}
      ...
      <div style={{ marginTop: '32px', padding: '16px 20px', borderRadius: '12px', background: 'rgba(249,115,22,0.06)', border: `1px solid rgba(249,115,22,0.2)` }}>
