...
.lp-nav-link{font-family:'Tajawal','SF Pro Display','Inter',sans-serif;font-size:14px;font-weight:500;color:#6E6E73;text-decoration:none;transition:color .15s;white-space:nowrap;}
.lp-nav-link:hover{color:#1D1D1F;}

.lp-btn-primary{display:inline-flex;align-items:center;justify-content:center;gap:6px;height:46px;padding:0 28px;background:#0071E3;color:#fff;border:none;border-radius:980px;cursor:pointer;font-family:'Tajawal','SF Pro Display','Inter',sans-serif;font-size:15px;font-weight:500;letter-spacing:-.01em;white-space:nowrap;transition:background .15s,transform .1s;}
...
.lp-btn-outline{display:inline-flex;align-items:center;justify-content:center;gap:6px;height:46px;padding:0 22px;background:transparent;color:#1D1D1F;border:1px solid #D2D2D7;border-radius:980px;cursor:pointer;font-family:'Tajawal','SF Pro Display','Inter',sans-serif;font-size:14px;font-weight:400;white-space:nowrap;transition:border-color .15s,background .15s;}
.lp-btn-outline:hover{border-color:#1D1D1F;background:#F5F5F7;}

.lp-card{background:#fff;border:1px solid #D2D2D7;border-radius:18px;padding:24px;transition:box-shadow .2s,transform .2s;}
.lp-card:hover{box-shadow:0 12px 36px rgba(0,0,0,.08);transform:translateY(-2px);}

.lp-feature-icon{width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:14px;flex-shrink:0;}

.lp-pricing-card{background:#fff;border:1px solid #D2D2D7;border-radius:18px;padding:28px;position:relative;}
.lp-pricing-card-popular{border-color:#0071E3;box-shadow:0 12px 40px rgba(0,113,227,.14);}
...
.lp-faq-btn{width:100%;background:none;border:none;padding:20px 0;cursor:pointer;font-family:'Tajawal','SF Pro Display','Inter',sans-serif;font-size:16px;font-weight:500;color:#1D1D1F;display:flex;align-items:center;justify-content:space-between;gap:12;text-align:right;}
...
// Minimal: white + near-black + single accent blue.
// Surfaces use Apple's signature #F5F5F7, text uses #1D1D1F.
const C = {
  bg: '#FFFFFF',
  ...
  sub: '#6E6E73', // Apple secondary text
  muted: '#86868B', // Apple tertiary
  ...
  return (
    <div
      style={{
        borderRadius: 14,
        overflow: 'hidden',
        boxShadow: '0 24px 64px rgba(15,23,42,.16), 0 4px 16px rgba(15,23,42,.08)',
...
function Navbar({ onLogin, onRegister }: { onLogin: () => void; onRegister: () => void }) {
  ...
  return (
    <div
      style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, padding: '14px 24px' }}
    >
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 5, flexShrink: 0 }}>
              <span
                style={{ fontSize: 18, fontWeight: 800, color: C.text, letterSpacing: '-0.03em' }}
              >
                مُحكم
              </span>
            </div>
            ...
            >
              {links.map(([id, lbl]) => (
                <a
                  ...
                  style={{ padding: '6px 14px', borderRadius: 100 }}
                >
                  {lbl}
                </a>
              ))}
            ...
            >
              {[0, 1, 2].map((i) => (
                <div
                  key={i}
                  style={{ width: 20, height: 1.5, background: C.text, borderRadius: 2 }}
                />
              ))}
            </button>
          </div>
          ...
          {open && (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 16 }}>
                <button onClick={onLogin} className="lp-btn-outline" style={{ width: '100%' }}>
                  تسجيل الدخول
                </button>
                <button onClick={onRegister} className="lp-btn-primary" style={{ width: '100%' }}>
                  سجّل الآن
                </button>
              </div>
            </div>
...
function HeroSection({ onRegister, onLogin }: { onRegister: () => void; onLogin: () => void }) {
  return (
    <section style={{ paddingTop: 120, paddingBottom: 96, background: C.bg }}>
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 24px', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 64 }}>
          ...
          >
            ...
            <p
              style={{
                ...
                maxWidth: 480,
                textAlign: 'right',
                animation: 'lp-up .5s .10s ease both',
              }}
            >
              محكم منصة ERP عربية لإدارة المبيعات، المخزون، الحسابات، الصيانة والموظفين من مكان
              واحد.
            </p>
            ...
            <div
              style={{
                ...
                gap: 12,
                marginBottom: 28,
                animation: 'lp-up .5s .14s ease both',
                flexWrap: 'wrap',
            ...
            >
              {['لا تحتاج بطاقة ائتمان', 'إعداد سريع', 'دعم مباشر'].map((c) => (
                <span key={c} className="lp-check" style={{ fontSize: 13 }}>
                  {c}
                </span>
              ))}
            </div>
          ...
          <div
            ...
            style={{ flex: 1, animation: 'lp-fade .7s .1s ease both' }}
          >
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          >
            ...
            >
              <span style={{ fontSize: 10, color: '#475569', fontFamily: 'Inter, monospace' }}>
        ...
        <div style={{ display: 'flex', gap: 64, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div className="lp-reveal" style={{ flex: '0 0 44%', minWidth: 280 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                'عرض لوحة التحكم ومؤشرات الأداء',
                'إصدار الفواتير من الجوال مباشرة',
                'استعراض المخزون وإنشاء طلبات الشراء',
                'متابعة حالة طلبات الصيانة',
              ].map((f) => (
                <span key={f} className="lp-check" style={{ fontSize: 14 }}>
                  {f}
                </span>
              ))}
            </div>
          ...
          <div
            ...
            style={{ flex: 1, display: 'flex', justifyContent: 'center', minWidth: 240 }}
          >
            <div
              style={{
                width: 220,
                borderRadius: 32,
                overflow: 'hidden',
                boxShadow: '0 32px 64px rgba(15,23,42,.2)',
            ...
            >
              ...
              <div style={{ padding: 14, background: '#0F1117', minHeight: 360 }}>
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        justifyContent: 'space-between',
                        padding: '5px 0',
                        borderBottom: i < 2 ? '1px solid #252530' : 'none',
                        fontSize: 9,
                      }}
                    >
                ...
                >
                  {['🏠', '📦', '💰', '👤'].map((ic) => (
                    <div key={ic} style={{ fontSize: 16, textAlign: 'center', padding: '4px 8px' }}>
                      {ic}
                    </div>
                  ))}
                </div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
        <div className="lp-reveal" style={{ textAlign: 'center' }}>
          <SectionHeader
            center
            eyebrow="الأسعار"
            title="خطط واضحة بلا رسوم خفية"
            sub="ابدأ مجاناً لمدة ٧ أيام. لا تحتاج بطاقة ائتمان."
          />
        </div>
        <div
        ...
        >
          {PLANS.map((p, i) => (
            <div
              key={i}
              className={`lp-pricing-card lp-reveal lp-d${Math.min(i + 1, 4) as 1 | 2 | 3 | 4}${p.popular ? ' lp-pricing-card-popular' : ''}`}
            >
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 24 }}>
                  <span
                    style={{
                      fontSize: 36,
                      fontWeight: 800,
                      color: p.popular ? C.primary : C.text,
              ...
              {p.enterprise ? (
                ...
                <button
                  ...
                  style={{ width: '100%', height: 46, marginBottom: 20 }}
                >
                  ابدأ مجاناً
                </button>
              )}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {p.features.map((f) => (
                  <span key={f} className="lp-check" style={{ fontSize: 12 }}>
                    {f}
                  </span>
                ))}
              </div>
        ...
        >
          ...
          <div>
            ...
            <a
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.opacity = '.8';
              }}
              onMouseLeave={(e) => {
