...
const BENTO: BentoItem[] = [
  {
    title: 'المحاسبة الكاملة',
    desc: 'قيد مزدوج تلقائي، ميزانية عمومية، وقائمة الدخل بضغطة واحدة.',
    cls: 'lp-wide',
    mockup: <MiniAccounting />,
  },
  {
    title: 'المبيعات ونقطة البيع',
    desc: 'فواتير لحظية، POS متكامل، خصومات وتقارير يومية.',
    cls: '',
    mockup: <MiniSales />,
  },
  {
    title: 'إدارة المخزون',
    desc: 'تتبع الكميات في الوقت الفعلي مع تنبيهات النفاد.',
    cls: '',
    mockup: <MiniInventory />,
  },
  {
    title: 'الموارد البشرية',
    desc: 'الرواتب، المكافآت، الحضور، والإجازات في مكان واحد.',
    cls: 'lp-wide',
    mockup: <MiniHR />,
  },
  {
    title: 'وحدة الصيانة',
    desc: 'بطاقات IMEI، تعيين الفنيين، وتتبع الحالات.',
    cls: '',
    mockup: <MiniRepair />,
  },
  {
    title: 'التقارير والتحليلات',
    desc: 'لوحة تحكم تفاعلية ومؤشرات أداء رئيسية.',
    cls: '',
    mockup: <MiniReports />,
  },
  {
    title: 'المطابقة البنكية',
    desc: 'ربط الحسابات البنكية ومطابقة تلقائية.',
    cls: '',
    mockup: <MiniBank />,
  },
  {
    title: 'تطبيق موبايل لفريقك بالكامل',
    desc: 'iOS و Android — حضور GPS، بطاقات صيانة، فواتير، ومتابعة الأداء.',
    cls: 'lp-full',
    mockup: <MiniMobile />,
  },
];
  ...
  useEffect(() => {
    ...
    const so = new IntersectionObserver(
      (entries) =>
        entries.forEach((en) => {
          if (en.isIntersecting) {
            startCount();
            en.target.classList.add('lp-stats-live');
    ...
    const co = new IntersectionObserver(
      (entries) =>
        entries.forEach((en) => {
          if (en.isIntersecting) {
            en.target.classList.add('lp-chart-live');
    ...
    <div style={{ background: '#0F172A', color: '#F8FAFC', minHeight: '100vh', ...mono }}>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
            <div
              style={{ fontSize: 22, fontWeight: 800, color: '#F8FAFC', letterSpacing: '-0.02em' }}
            >
              مُحكم
            </div>
            <div
              style={{ fontSize: 11, fontWeight: 600, color: '#3B82F6', letterSpacing: '0.08em' }}
            >
              ERP
            </div>
          </div>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: 820, width: '100%' }}>
          ...
          >
            مُحكم ERP — نظام متكامل للمبيعات، المحاسبة، الموارد البشرية، والصيانة. مصمم خصيصاً
            للشركات الصغيرة والمتوسطة في السوق العربي.
          </p>
          ...
          >
            ...
            <button
              onClick={
                scrollToId('features') as unknown as React.MouseEventHandler<HTMLButtonElement>
              }
              className="lp-btn-secondary"
              style={{ padding: '14px 28px', fontSize: 15 }}
            >
                ...
                >
                  {(
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 16, fontWeight: 700, color: '#F8FAFC', marginBottom: 3 }}
                      >
                        {val}
                      </div>
      ...
      >
        ...
        >
          {[...TICKER, ...TICKER, ...TICKER].map((item, i) => (
            <span
              key={i}
              style={{ fontSize: 13, fontWeight: 600, color: item === '·' ? '#3B82F6' : '#64748B' }}
            >
              {item}
            </span>
          ))}
      ...
      <section
        dir="rtl"
        ref={statsEl}
        style={{ background: '#0F172A', borderBottom: '1px solid #1E293B', padding: '96px 28px' }}
      >
        <div
          className="lp-grid-4"
          style={{
                ...
                {s.kind === 'num' ? (
                  <>
                    <span
                      ...
                      style={{ color: '#F8FAFC', animationDelay: `${i * 0.1}s` }}
                    >
                      {fmtCount(i)}
                    </span>
      ...
      <section id="features" dir="rtl" style={{ padding: '136px 28px', background: '#0F172A' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="lp-fade" style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            >
              من إصدار الفواتير إلى احتساب الرواتب — كل وحدة مترابطة بإحكام لتمنحك صورة دقيقة عن
              أعمالك.
            </p>
          </div>
            ...
            {BENTO.map((f, i) => (
              <div
                ...
                style={{
                  ...
                  flexDirection: 'column',
                  gridColumn:
                    f.cls === 'lp-full' ? '1/-1' : f.cls === 'lp-wide' ? 'span 2' : 'span 1',
                }}
              >
                <h3
                  style={{
      ...
      >
        ...
        >
          <div
            className="lp-spotlight lp-fade"
            style={{
              display: 'grid',
          ...
          >
            ...
            <div style={{ ...cardSurface, padding: 24 }}>
              ...
              <div style={{ marginTop: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                >
                  <div
                    style={{ height: '100%', width: '65%', background: '#3B82F6', borderRadius: 3 }}
                  />
                </div>
          ...
          >
            <div style={{ ...cardSurface, padding: 24, direction: 'rtl' }}>
              <div style={{ marginBottom: 16 }}>
                ...
                >
                  ١٢٤٬٨٠٠{' '}
                  <span style={{ fontSize: 14, color: '#64748B', fontWeight: 400 }}>جنية</span>
                </div>
              ...
              >
                {(
                  [
                    ['المصروفات', '٤٨٬٢٠٠ ج', '#EF4444'],
                    ['صافي الربح', '٧٦٬٦٠٠ ج', '#10B981'],
                  ] as [string, string, string][]
                ).map(([l, v, c]) => (
                  <div
                    key={l}
            ...
            <div style={{ direction: 'rtl' }}>
              ...
              >
                {['قيد مزدوج تلقائي', 'ربط بنكي مباشر', 'تقارير ضريبية', 'مراكز التكلفة'].map(
                  (item) => (
                    <li
                      key={item}
                      style={{
        ...
        <div style={{ maxWidth: 920, margin: '0 auto' }}>
          <div className="lp-fade" style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ color: '#94A3B8', fontSize: 16 }}>
              ابدأ مجاناً لمدة 7 أيام — بدون بطاقة ائتمان
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{ textAlign: 'center', color: '#64748B', fontSize: 12, marginTop: 14 }}>
                7 أيام تجريبية — بدون بطاقة
              </p>
            </div>
                  ...
                  {[
                    ...
                    <li
                      ...
                      style={{
                        ...
                        gap: 10,
                        fontSize: 14,
                        color: item === 'كل ما في Pro +' ? '#60A5FA' : '#E2E8F0',
                        fontWeight: item === 'كل ما في Pro +' ? 600 : 500,
                      }}
                    >
                      <svg
                        width="14"
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
            <span
              style={{ fontSize: 18, fontWeight: 800, color: '#F8FAFC', letterSpacing: '-0.02em' }}
            >
              مُحكم
            </span>
            <span
