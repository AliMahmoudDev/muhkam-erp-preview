/**
 * audit-tab.tsx — سجل التدقيق مُضمَّن داخل صفحة الإعدادات
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-white/40 mt-0.5">
            {filtered.length} من {logs.length} سجل
          </p>
        </div>
        <button
              ...
              {filtered.map((log, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <JsonDiff label="القديم" data={log.old_value} />
                      <JsonDiff label="الجديد" data={log.new_value} />
                    </td>
                  </tr>
                );
              })}
