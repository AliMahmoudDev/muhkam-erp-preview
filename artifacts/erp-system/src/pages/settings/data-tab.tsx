    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="flex gap-2">
        ...
        >
          ...
          {mainTab !== 'danger' && (
            <span className="text-[10px] font-black text-red-500/60 mr-1">⚠</span>
          )}
        </button>
      </div>
          ...
          <div className="bg-[#111827] border border-white/8 rounded-2xl overflow-hidden">
            <div className="flex border-b border-white/8">
              {(
                ...
                >
                  <span className={importTab === id ? 'text-amber-400' : 'text-white/30'}>
                    {icon}
                  </span>
                  <div>
                    <p
                      className={`text-sm font-bold ${importTab === id ? 'text-amber-400' : 'text-white/50'}`}
                    >
                      {label}
                    </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 border border-white/10 hover:border-white/20 rounded-xl text-white/40 hover:text-white text-xs transition-all"
                    >
                  ...
                  {prodResult && (
                    ...
                    >
                      ...
                      <span>
                        ...
                        {prodResult.failed > 0 && (
                          <span className="text-red-400"> — فشل {prodResult.failed}</span>
                        )}
                      </span>
                    </div>
                  )}
                ...
                {!purParsed ? (
                  <div className="space-y-3">
                    <p className="text-white/50 text-sm">
                      ارفع ملف Excel يحتوي بنود فاتورة المشتريات
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <button
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <SSelect
                          value={purPayType}
                          onChange={(e) => setPurPayType(e.target.value as 'cash' | 'credit')}
                        >
                        ...
                        <thead>
                          <tr className="bg-white/3 border-b border-white/8">
                            {['SKU', 'الصنف', 'الكمية', 'السعر', 'الإجمالي', 'الحالة'].map((h) => (
                              <th
                                key={h}
                                className="px-3 py-2.5 text-right text-white/35 font-medium"
                              >
                                {h}
                              </th>
                            ))}
                        ...
                        <tbody>
                          {purRows.map((r) => {
                            ...
                            return (
                              <tr
                                key={r.idx}
                                className={`border-b border-white/4 ${hasErr ? 'bg-red-500/5' : 'hover:bg-white/2'}`}
                              >
                                ...
                                <td className="px-3 py-2">
                                  <input
                                    ...
                                    value={r.quantity}
                                    onChange={(e) =>
                                      updatePurRow(r.idx, 'quantity', e.target.value)
                                    }
                                ...
                                <td className="px-3 py-2">
                                  <input
                                    ...
                                    value={r.unitPrice}
                                    onChange={(e) =>
                                      updatePurRow(r.idx, 'unitPrice', e.target.value)
                                    }
                                ...
                                <td className="px-3 py-2 text-white/45 font-mono">
                    ...
                    >
                      ...
                      {purConfirming
                        ? 'جاري إنشاء الفاتورة...'
                        : `تأكيد استيراد ${validRows.length} صنف وإنشاء فاتورة`}
                    </button>
                  </>
                )}
              </div>
              ...
              <div className="divide-y divide-white/4">
                {log.map((e) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`px-2 py-0.5 rounded-md text-[10px] font-bold shrink-0 ${s.cls}`}
                      >
                        {s.label}
                      </span>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between mb-0.5">
                          <span
                            className={`text-xs font-bold flex items-center gap-1 ${on ? 'text-red-300' : 'text-white/60'}`}
                          >
                  ...
                  <div className="space-y-3 pt-2 border-t border-red-500/10">
                    <div>
                      <label className="text-white/45 text-xs block mb-2">
                        اكتب <span className="text-red-400 font-black">"تأكيد الحذف"</span> لتفعيل
                        الزر:
                      </label>
                      <SInput
