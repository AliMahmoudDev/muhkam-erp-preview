export const ROLES: Record<string, { label: string; badge: string; avatarBg: string; avatarText: string }> = {
  ...
  branch_manager: { label: "مدير الفرع",     badge: "text-sky-400 bg-sky-500/15 border-sky-500/30",           avatarBg: "bg-sky-500/20",     avatarText: "text-sky-300"     },
  ...
  manager:        { label: "مشرف",           badge: "text-amber-400 bg-amber-500/15 border-amber-500/30",     avatarBg: "bg-amber-500/20",   avatarText: "text-amber-300"   },
