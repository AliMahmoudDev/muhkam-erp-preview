...
/* ─── Fiscal Year Start Card ─── */
function FiscalYearStartCard() {
  const { toast } = useToast();
  ...
  return (
    <div
      className="rounded-2xl border border-amber-500/20 bg-amber-500/[0.04] p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4"
    >
