...
export default function BackupRestoreModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-canvas border border-red-500/30 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer" onClick={onToggleUnderstood}>
            <div
            ...
            <span className="text-ink/55 text-sm leading-relaxed select-none">
              أفهم أن <span className="text-red-400 font-bold">جميع البيانات الحالية ستُحذف</span>
            </span>
          </label>
