...
export const NAV_ITEMS: { name: string; href: string; icon: LucideIcon; roles: AppRole[] }[] = [
  ...
  { name: 'جرد المخزون', href: '/stock-count', icon: ClipboardList, roles: ['admin', 'manager'] },
  { name: 'تحويل المخزون', href: '/stock-transfers', icon: ArrowRightLeft, roles: ['admin', 'manager'] },
  {
    name: 'العملاء',
    href: '/customers',
    icon: Users,
  ...
  { name: 'الموردون', href: '/suppliers', icon: Truck, roles: ['admin', 'manager'] },
