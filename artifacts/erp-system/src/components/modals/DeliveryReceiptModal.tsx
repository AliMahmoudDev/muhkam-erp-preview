              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 pt-2 border-t border-line space-y-1">
                    <div className="flex justify-between">
                      <span className="text-ink/50">تكلفة الإصلاح:</span>
                      <span className="text-ink">{fmt(data.final_cost)}</span>
                    </div>
                    {data.parts_total > 0 && (
                      <div className="flex justify-between">
                        <span className="text-ink/50">قطع الغيار:</span>
                        <span className="text-ink">{fmt(data.parts_total)}</span>
                      </div>
                    )}
                    {data.shipping_cost > 0 && (
                      <div className="flex justify-between">
                        <span className="text-ink/50">الشحن:</span>
                        <span className="text-ink">{fmt(data.shipping_cost)}</span>
                      </div>
                    )}
                    {data.final_discount > 0 && (
                      <div className="flex justify-between text-red-400">
                        <span>خصم نهائي:</span>
                        <span>- {fmt(data.final_discount)}</span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between text-emerald-300">
                      <span>المدفوع:</span>
                      <span>{fmt(data.deposit_paid)}</span>
                    </div>
