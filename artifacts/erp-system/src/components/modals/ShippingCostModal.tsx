  ...
  async function handleSave() {
    ...
    try {
      ...
      toast({
        ...
        description: isZero
          ? 'تم تأكيد عدم وجود تكلفة شحن'
          : `تم خصم ${numericCost.toFixed(2)} ج وإنشاء مصروف تلقائي`,
      });
      onSaved();
    } catch {
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {isZero
                  ? 'تأكيد بدون تكلفة وانتقال إلى "تم التسليم"'
                  : 'حفظ تكلفة الشحن وانتقال إلى "تم التسليم"'}
              </>
            )}
          </button>
          <button
