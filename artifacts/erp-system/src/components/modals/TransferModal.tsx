        ...
        {(fromSafe || toSafe) && (
          <div className="flex items-center gap-3 bg-violet-500/10 border border-violet-500/20 rounded-2xl px-4 py-3">
            <div className="flex-1 text-center">
              ...
              {fromSafe && <p className="text-ink/30 text-xs">{formatCurrency(Number(fromSafe.balance))}</p>}
            </div>
            ...
            <div className="flex-1 text-center">
              ...
              {toSafe && <p className="text-ink/30 text-xs">{formatCurrency(Number(toSafe.balance))}</p>}
            </div>
          </div>
        )}
