...
export default function DeliveryGateForm({
  ...
  return (
    <div className="overflow-y-auto max-h-[65vh]">
      ...
      <div className="px-5 pt-4 pb-3 border-b border-line">
        <h4 className="text-[12px] font-black text-ink/80 mb-3 flex items-center gap-2">
          <span className="w-5 h-5 rounded-md bg-blue-500/15 border border-blue-400/25 flex items-center justify-center text-[9px] text-blue-300 font-black">
            +
          </span>
        ...
        <div className="flex flex-wrap gap-2 items-end">
          <div className="flex-1 min-w-[180px] relative">
            ...
            {showProductDrop && filteredProducts.length > 0 && (
              <div
                className="absolute top-full right-0 left-0 z-50 mt-1 rounded-xl border border-line overflow-hidden"
                style={{
              ...
              >
                {filteredProducts.map((p) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] text-ink/40 shrink-0 mr-2">
                      {fmtCurrency(Number(p.sell_price))}
                    </span>
                  </button>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-2 items-end">
                <div style={{ width: 110 }}>
                  ...
                  <input
                    ...
                    step="any"
                    value={extVendorCost}
                    onChange={(e) => setExtVendorCost(e.target.value)}
                    placeholder="0.00"
                    dir="ltr"
                  ...
                  <>
                    <div>
                      ...
                      <div className="flex gap-1">
                        <button
                          type="button"
                          onClick={() => setExtVendorPayType('cash')}
                ...
                <div key={l.id} className="px-3 py-2 rounded-xl" style={cardStyle}>
                  ...
                  <div className="mt-1.5 flex items-center gap-2 pl-7">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateLineDiscount(l.id, parseFloat(e.target.value) || 0, l.discount_mode)
                      }
                      className="w-16 px-2 py-0.5 rounded-md bg-surface border border-amber-400/20 text-[10px] text-ink text-center focus:outline-none"
                      dir="ltr"
                    />
                    <button
                      type="button"
          ...
          <div className="space-y-2">
            <div className="flex gap-1.5">
              <button
                ...
                className={`flex-1 py-1.5 rounded-xl text-[11px] font-bold flex items-center justify-center gap-1.5 transition-all ${payType === 'cash' ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/40' : 'bg-surface text-ink/50 border border-line'}`}
              >
            ...
            <div className="flex gap-1.5 items-stretch">
              ...
              <div className="relative shrink-0" style={{ width: 96 }}>
                <input
                  ...
                  className="w-full px-2.5 py-1.5 rounded-lg bg-surface border border-line text-[11px] text-ink placeholder:text-ink/30 focus:outline-none"
                  dir="ltr"
                />
