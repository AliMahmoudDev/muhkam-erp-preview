  ...
  const doCheckIn = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `حضرت الساعة ${new Date().toLocaleTimeString('ar-EG', { hour: '2-digit', minute: '2-digit' })}`,
      });
      refetchToday();
    } catch (e) {
      toast({
    ...
    >
      ...
      >
        ...
        >
          ...
          {Boolean(emp.job_title_ar || emp.department_name_ar) && (
            <p style={{ fontSize: 13, color: muted, marginTop: 4 }}>
              {String(emp.job_title_ar ?? '')}{' '}
              {emp.department_name_ar ? `· ${String(emp.department_name_ar)}` : ''}
            </p>
          )}
          <div
            style={{
        ...
        {empId && (
          ...
          >
            ...
            {attendLoading ? (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'var(--status-warning)' }}>
        ...
        {deviceWarning && (
          ...
          >
            <Smartphone
              style={{ width: 18, height: 18, color: 'var(--status-danger)', flexShrink: 0, marginTop: 1 }}
            />
            <div>
              <p style={{ fontSize: 13, fontWeight: 700, color: 'var(--status-danger)', marginBottom: 2 }}>
