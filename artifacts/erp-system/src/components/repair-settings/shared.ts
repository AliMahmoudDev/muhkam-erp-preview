...
export interface DeviceCategory { key: string; label: string; emoji: string; }
export interface Manufacturer { key: string; label: string; emoji: string; categories: DeviceCategory[]; }
