...
export default function DefaultsTab() {
  ...
  useEffect(() => {
    setWarrantyBuf(initialWarranty);
  }, [initialWarranty]);
    ...
    <div className="h-full overflow-y-auto">
      <div className="p-5 space-y-5">
        <div className="flex items-start gap-3 p-4 rounded-xl bg-emerald-500/8 border border-emerald-500/20">
          ...
          <div>
            <p className="text-[13px] font-semibold text-emerald-300/80 mb-1">
              القيم الافتراضية للصيانة
            </p>
        ...
        <div className="rounded-xl border border-line overflow-hidden">
          <div className="px-4 py-3 bg-surface border-b border-line">
            <span className="text-[12px] font-semibold text-ink/50">
              مدة الضمان الافتراضية بعد الإصلاح
            </span>
          </div>
          <div className="p-4 flex items-center gap-3">
            ...
            <span className="text-[11px] text-ink/25 mr-auto">
              يستخدم في بطاقات الضمان عند تسليم الجهاز
            </span>
          </div>
        </div>
