...
export function NotificationBell() {
  ...
  async function openAdvanceApproveModal(n: AppNotification) {
    ...
    try {
      ...
      if (r.ok) {
        ...
        const list: SafeOption[] = Array.isArray(j)
          ? j
          : ((j as { data?: SafeOption[] }).data ?? []);
  ...
  async function confirmAdvanceApprove() {
    ...
    if (!advSelectedSafeId) {
      toast({
        title: 'اختر الخزينة',
        description: 'يجب اختيار خزينة لصرف مبلغ السلفة منها',
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      ...
      if (r.ok) {
        ...
        toast({
          ...
          description: j?.error || 'تعذّر اعتماد السلفة',
          variant: 'destructive',
        });
      }
    } finally {
    ...
    <div ref={dropdownRef} style={{ position: 'relative' }}>
      ...
      {advApproveNotif && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget && !advApproving) setAdvApproveNotif(null);
          }}
        >
          <div
            style={{
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => {
                  if (!advApproving) setAdvApproveNotif(null);
                }}
                style={{
                  background: 'none',
                  border: 'none',
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ textAlign: 'left' }}>
                          ...
                          >
                            {bal.toLocaleString('ar-EG-u-nu-latn', {
